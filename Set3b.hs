...
indexDefault (value : _) 0 _ = value
indexDefault (_ : values) i def = indexDefault values (i - 1) def
...
sorted :: [Int] -> Bool
sorted (v1 : v2 : vs) = (v1 <= v2) && sorted (v2 : vs)
sorted _ = True
...
sumsOf :: [Int] -> [Int]
sumsOf (v1 : v2 : vs) = v1 : sumsOf ((v1 + v2) : vs)
sumsOf vs = vs
